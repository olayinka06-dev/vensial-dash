...
const ContactInfoRegister = ({handleContinue}) => {
    ...
    <div className="animation p-12 h-auto mb-4 rounded-2xl bg-white shadow capitalize">
      ...
      <form className="mt-7">
        ...
        <div className="grid gap-6 mb-6 md:grid-cols-2">
          ...
          <div>
            <label
              htmlFor="dispute_email"
              className="block mb-2 text-sm font-medium text-gray-900  "
            >
              Dispute email <span className="text-red-500">*</span>
            </label>

            <input
              type="email"
              id="dispute_email"
              value={userDetails.dispute_email}
              name='dispute_email'
              onChange={handleChangeInput}
              className="block w-full p-4 text-gray-900 border border-gray-300 rounded-2xl bg-white sm:text-md focus:cyan-400 focus:cyan-400"
              placeholder="jaysalimi.msme@gmail.com"
          ...
          <div>
            <label
              ...
              className="block mb-2 text-sm font-medium text-gray-900  "
            >
              wesbite link <span className="text-red-500">*</span>
            </label>
            <input
              type="text"
              name='website_link'
              ...
              id="website_link"
              className="block w-full p-4 text-gray-900 border border-gray-300 rounded-2xl bg-white sm:text-md focus:cyan-400 focus:cyan-400"
              placeholder="https://jaysacad.com"
              required
            />
          </div>
          <div>
